...
/**
 * Service Pricing Table Section - Table Layout
 * Template part: template-parts/service/pricing-table-comparison.php
 * 
...
<section class="pricing-comparison">
    <div class="pricing-comparison__container">
        <div class="pricing-comparison__header">
            <h2 class="pricing-comparison__title">Service Pricing Comparison</h2>
            <p class="pricing-comparison__subtitle">
                Compare our service packages to find the best option for your needs
            </p>
        </div>
                ...
                <thead>
                    ...
                    <tr class="pricing-comparison__price-row">
                        ...
                        <?php foreach ($pricing_plans as $plan): 
                            ...
                            ?>
                            <td class="<?= esc_attr($td_class); ?>">
                                <div class="pricing-comparison__price">
                                    <span class="pricing-comparison__currency">$</span>
                                    <span class="pricing-comparison__amount"><?= esc_html($price); ?></span>
                                </div>
                            </td>
                        <?php endforeach; ?>
                    </tr>
