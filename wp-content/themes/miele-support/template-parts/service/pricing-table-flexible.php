 ...
 * Template part: template-parts/service/pricing-table-flexible.php
 *
...
$section_subtitle = !empty($section_data['subtitle']) ? $section_data['subtitle'] : 'Transparent pricing for quality Miele appliance repair';
...
<section class="pricing-table">
    <div class="pricing-table__container">
        <div class="pricing-table__header">
            <h2 class="pricing-table__title"><?php echo esc_html($section_title); ?></h2>
                ...
                <div class="<?php echo esc_attr($card_class); ?>">
                    ...
                    <div class="pricing-table__price-wrapper">
                        ...
                        <div class="pricing-table__price">
                            ...
                            <span class="pricing-table__amount"><?php echo esc_html($price); ?></span>
                        </div>
                    </div>
                        ...
                        <ul class="pricing-table__features">
                            <?php foreach ($features as $feature): ?>
                                <li class="pricing-table__feature">
                                    ...
                                    <span><?php echo esc_html($feature['feature'] ?? $feature); ?></span>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    <?php endif; ?>
